      ...
      {pendingVerification && (
        <div>
          <form className="space-y-4 md:space-y-6">
            ...
            <button type="submit" onClick={onPressVerify} className="w-full text-white bg-blue-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
              Verify Email
            </button>
          </form>
        </div>
